...
const Hyperspeed = ({
  effectOptions = {
    ...
    colors: {
      ...
      // leftCars: [0xffffff, 0x888888, 0x444444],
      // rightCars: [0xffffff, 0xcccccc, 0x666666],
      // sticks: 0xffffff
        roadColor: 0x080808,
      islandColor: 0x0a0a0a,
      background: 0x000000,
  ...
  useEffect(() => {
    ...
    class App {
      ...
      update(delta: number) {
        ...
        let fovChange = (this.fovTarget - this.camera.fov) * lerpPercentage;
    ...
    class CarLights {
      webgl: App; options: any; colors: any; speed: any; fade: any; mesh: THREE.Mesh | null = null;
    ...
    class LightsSticks {
      webgl: App; options: any; mesh: THREE.Mesh | null = null;
    ...
    class Road {
      webgl: App; options: any; uTime: { value: number };
      constructor(webgl: App, options: any) { this.webgl = webgl; this.options = options; this.uTime = { value: 0 }; }
